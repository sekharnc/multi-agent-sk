...
async def test_agent_has_system_message(agent_type, ai_project_client):
    ...
    domain_terms = {
        AgentType.COMPANY: ["company", "basic information", "business", "headquarters"],
        AgentType.HUMAN: ["human", "user", "feedback", "conversation"],
        AgentType.EARNINGCALLS: ["quarterly earnings", "10-K", "10-Q", "market risk"],
        AgentType.FUNDAMENTAL: ["P/E", "EBIDTA", "Cash flow", "assets and liabilities"],
        AgentType.SEC: ["SEC", "filing", "regulation", "disclosure"],
        AgentType.FORECASTER: ["forecast", "prediction", "future", "estimate"],
        AgentType.TECHNICAL: ["Moving average", "ADX", "Support and Resistance", "Bollinger Bands"],
    }
