...
class AgentIntegrationTest(unittest.TestCase):
    ...
    async def _test_create_all_agents(self):
        ...
        expected_types = [
            AgentType.COMPANY, AgentType.EARNINGCALLS, AgentType.FORECASTER, AgentType.SEC,
            AgentType.FUNDAMENTAL, AgentType.TECHNICAL,
    ...
    async def _test_get_agents(self):
        ...
        expected_agent_names = [
            "CompanyAnalystAgent", "EarningCallsAgent", "ForecasterAgent", "SecAgent",
            "FundamentalAnalysisAgent", "TechnicalAnalysisAgent", "GenericAgent",
